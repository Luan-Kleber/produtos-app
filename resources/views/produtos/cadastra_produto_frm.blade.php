...
<div class="container">
    <div class="row mt-5">
        <div class="col">
            ...
            <form action="{{route('cadastra_produto_submit')}}" method="post">
                @csrf
                <div class="row">
                    {{-- nome --}}
                    <div class="col">
                        <div class="mb-3">
                            <label for="text_produto_name" class="form-label">Nome</label>
                                <input type="text" name="text_produto_name" id="text_produto_name" class="form-control" placeholder="Nome do produto" required value="{{old('text_produto_name')}}">
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="text" name="text_produto_descricao" id="text_produto_descricao" class="form-control" placeholder="Descrição do produto" value="{{old('text_produto_descricao')}}">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="number" name="number_produto_preco" id="number_produto_preco" step="0.01" min="0" class="form-control" placeholder="Preço do produto" required value="{{old('number_produto_preco')}}">
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <input type="number" name="number_produto_qtde" id="number_produto_qtde" step="1" min="0" class="form-control" placeholder="Qtde. Estoque do produto" required value="{{old('number_produto_qtde')}}">
